...
/**
 * This is the model class for table "compare_saler".
 *
 * @property int $id
 * @property int $user_id
 * @property int $good_id
 * @property string $good_salers 促销内容
 ...
 */
class CompareSaler extends Base
{
    /**
     * @inheritdoc
     */
    ...
    public static function salerSave($good_id,$coupons,$user_id='')
    {
        $model = new CompareSaler();
        $model->user_id = $user_id?$user_id:Yii::$app->user->id;
        $model->good_id = $good_id;
        $model->good_salers = $coupons;
        $model->is_change = 1;
        $model->begin_at = time();
