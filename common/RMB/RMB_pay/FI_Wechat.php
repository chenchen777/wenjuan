...
<?PHP
	...
	$ext2 = "扩展2";
	//支付方式，一般为00，代表所有的支付方式。26-1代表微信公众号直连，必填。
	$payType = "26-1";
	...
	$pid = "";
	//聚合支付参数
	$aggregatePay = "26-1:[appId=wx089ce5449255261e,openId=oHcey01Os9xM-oxltNKEsTnqZZFk,limitPay=0]";
    ...
    $kq_all_para.=kq_ck_null($aggregatePay,'aggregatePay');
	...
	<body>
		...
		<div align="center" style="font-weight: bold;">
			<form name="kqPay" action="https://sandbox.99bill.com/mobilegateway/recvMerchantInfoAction.htm" method="post">
				...
				<input type="hidden" name="aggregatePay" value="<?PHP echo $aggregatePay; ?>" />
